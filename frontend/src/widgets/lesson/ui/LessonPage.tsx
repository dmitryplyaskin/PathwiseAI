...
export const LessonPage = () => {
  ...
  // Показываем полноэкранный прелоадер только при первичной загрузке.
  // При фоновой перезагрузке (например, после прохождения теста) не размонтируем страницу,
  // иначе закроются модалки (в т.ч. окно результата теста).
  if (loading && !lesson) {
